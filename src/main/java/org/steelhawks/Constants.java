...
public final class Constants {
    ...
    public static final class NotePose {
        ...
        public static final Pose2d FAR_NOTE_01 = RobotContainer.getAlliance() == DriverStation.Alliance.Blue ? new Pose2d(new Translation2d(8.286359, 7.431425), new Rotation2d()) :
            new Pose2d(new Translation2d(8.286359, 7.431425), new Rotation2d()).relativeTo(Red.ORIGIN);
        public static final Pose2d FAR_NOTE_02 = RobotContainer.getAlliance() == DriverStation.Alliance.Blue ? new Pose2d(new Translation2d(8.286359, 5.775726), new Rotation2d()) :
            new Pose2d(new Translation2d(8.286359, 5.775726), new Rotation2d()).relativeTo(Red.ORIGIN);
        public static final Pose2d FAR_NOTE_03 = RobotContainer.getAlliance() == DriverStation.Alliance.Blue ? new Pose2d(new Translation2d(8.286359, 4.120028), new Rotation2d()) :
            new Pose2d(new Translation2d(8.286359, 4.120028), new Rotation2d()).relativeTo(Red.ORIGIN);
        public static final Pose2d FAR_NOTE_04 = RobotContainer.getAlliance() == DriverStation.Alliance.Blue ? new Pose2d(new Translation2d(8.286359, 2.414157), new Rotation2d()) :
            new Pose2d(new Translation2d(8.286359, 2.414157), new Rotation2d()).relativeTo(Red.ORIGIN);
        public static final Pose2d FAR_NOTE_05 = RobotContainer.getAlliance() == DriverStation.Alliance.Blue ? new Pose2d(new Translation2d(8.286359, 0.758459), new Rotation2d()) :
            new Pose2d(new Translation2d(8.286359, 0.758459), new Rotation2d()).relativeTo(Red.ORIGIN);
    }
}
